...
<body>
    ...
    <header class="w3-container w3-padding-32">
        <div class="w3-bar w3-light-gray">
            ...
            <a href="homeUser.php" class="w3-bar-item w3-button w3-hide-small"></i> Home</a>
            ...
            <a href="../html/login.html" class="w3-bar-item w3-button w3-hide-small w3-right w3-light-gray"><i
